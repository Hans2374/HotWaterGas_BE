...
namespace Repos.Migrations
{
    ...
    [Migration("20260605130000_AddPublisherDeveloperUpdatedAtAndRelationships")]
    partial class AddPublisherDeveloperUpdatedAtAndRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repos.Models.Developers", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex(new[] { "Slug" }, "IX_Developers_Slug")
                        .IsUnique();
            ...
            modelBuilder.Entity("Repos.Models.ProductCategories", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Repos.Models.ProductTags", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Repos.Models.Products", b =>
                {
                    ...
                    b.HasIndex(new[] { "DeveloperId" }, "IX_Products_DeveloperId");
                    ...
                    b.HasIndex(new[] { "PublisherId" }, "IX_Products_PublisherId");
            ...
            modelBuilder.Entity("Repos.Models.Publishers", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex(new[] { "Slug" }, "IX_Publishers_Slug")
                        .IsUnique();
            ...
            modelBuilder.Entity("Repos.Models.Users", b =>
                {
                    ...
                    b.HasIndex(new[] { "RefreshToken" }, "IX_Users_RefreshToken");
            ...
            modelBuilder.Entity("Repos.Models.ProductCategories", b =>
                {
                    b.HasOne("Repos.Models.Categories", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Repos.Models.ProductTags", b =>
                {
                    ...
                    b.HasOne("Repos.Models.Tags", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Repos.Models.Products", b =>
                {
                    b.HasOne("Repos.Models.Developers", "Developer")
                        .WithMany("Products")
                    ...
                    b.HasOne("Repos.Models.Publishers", "Publisher")
                        .WithMany("Products")
